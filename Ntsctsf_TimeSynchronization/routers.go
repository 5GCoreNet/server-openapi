...
var routes = Routes{
...

	{
		...
		http.MethodPost,
		"/ntsctsf-time-sync/v1/subscriptions/:subscriptionId/configurations",
		CreateIndividualTimeSynchronizationExposureConfiguration,
	},

	{
		...
		http.MethodDelete,
		"/ntsctsf-time-sync/v1/subscriptions/:subscriptionId/configurations/:configurationId",
		DeleteIndividualTimeSynchronizationExposureConfiguration,
	},
...

	{
		...
		http.MethodDelete,
		"/ntsctsf-time-sync/v1/subscriptions/:subscriptionId",
		DeleteIndividualTimeSynchronizationExposureSubscription,
	},
...

	{
		...
		http.MethodPost,
		"/ntsctsf-time-sync/v1/subscriptions",
		TimeSynchronizationExposureSubscriptions,
	},
}
