...
var routes = Routes{
...

	{
		...
		http.MethodPost,
		"/capif-security/v1/securities/:securityId/token",
		SecuritiesSecurityIdTokenPost,
	},
...

	{
		...
		http.MethodPost,
		"/capif-security/v1/trustedInvokers/:apiInvokerId/delete",
		TrustedInvokersApiInvokerIdDeletePost,
	},
...

	{
		...
		http.MethodPost,
		"/capif-security/v1/trustedInvokers/:apiInvokerId/update",
		TrustedInvokersApiInvokerIdUpdatePost,
	},
}
