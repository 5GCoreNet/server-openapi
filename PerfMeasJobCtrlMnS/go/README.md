# Go API Server for PerfMeasJobCtrlMnS
...
- API version: 16.8.0
- Build date: 2023-01-19T10:53:45.068Z[Etc/UTC]
...
```
docker build --network=host -t PerfMeasJobCtrlMnS .
```

Once the image is built, just run
```
docker run --rm -it PerfMeasJobCtrlMnS
```
