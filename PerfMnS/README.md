# Go API Server for openapi_PerfMnS
...
- API version: 17.1.0
- Build date: 2023-01-25T17:21:21.299Z[Etc/UTC]
...
```
docker build --network=host -t openapi_PerfMnS .
```

Once the image is built, just run
```
docker run --rm -it openapi_PerfMnS
```
