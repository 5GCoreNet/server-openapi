...
var routes = Routes{
	{
		"Index",
		http.MethodGet,
		"/3GPPManagement/fileDataReportingMnS/XXX/",
		Index,
	},

	{
		"FilesGet",
		http.MethodGet,
		"/3GPPManagement/fileDataReportingMnS/XXX/files",
		FilesGet,
	},

	{
		"SubscriptionsPost",
		http.MethodPost,
		"/3GPPManagement/fileDataReportingMnS/XXX/subscriptions",
		SubscriptionsPost,
	},

	{
		...
		http.MethodDelete,
		"/3GPPManagement/fileDataReportingMnS/XXX/subscriptions/:subscriptionId",
		SubscriptionsSubscriptionIdDelete,
	},
}
