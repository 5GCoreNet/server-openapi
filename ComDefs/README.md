# Go API Server for openapi_ComDefs
...
- API version: 17.2.0
- Build date: 2023-01-25T17:23:51.780Z[Etc/UTC]
...
```
docker build --network=host -t openapi_ComDefs .
```

Once the image is built, just run
```
docker run --rm -it openapi_ComDefs
```
