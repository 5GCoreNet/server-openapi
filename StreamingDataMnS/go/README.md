# Go API Server for StreamingDataMnS
...
- API version: 17.1.0
- Build date: 2023-01-19T10:51:59.334Z[Etc/UTC]
...
```
docker build --network=host -t StreamingDataMnS .
```

Once the image is built, just run
```
docker run --rm -it StreamingDataMnS
```
