...
var routes = Routes{
...

	{
		...
		http.MethodPost,
		"/3gpp-m1/v2/provisioning-sessions/:provisioningSessionId/metrics-reporting-configurations",
		ActivateMetricsReporting,
	},

	{
		...
		http.MethodDelete,
		"/3gpp-m1/v2/provisioning-sessions/:provisioningSessionId/metrics-reporting-configurations/:metricsReportingConfigurationId",
		DestroyMetricsReportingConfiguration,
	},
