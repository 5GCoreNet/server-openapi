...
var routes = Routes{
...

	{
		...
		http.MethodPost,
		"/3gpp-m1/v2/provisioning-sessions/:provisioningSessionId/policy-templates",
		CreatePolicyTemplate,
	},

	{
		...
		http.MethodDelete,
		"/3gpp-m1/v2/provisioning-sessions/:provisioningSessionId/policy-templates/:policyTemplateId",
		DestroyPolicyTemplate,
	},
