...
var routes = Routes{
...

	{
		...
		http.MethodDelete,
		"/3gpp-m5/v2/network-assistance/:naSessionId",
		DestroyNetworkAssistanceSession,
	},
...

	{
		...
		http.MethodGet,
		"/3gpp-m5/v2/network-assistance/:naSessionId/recommendation",
		RequestBitRateRecommendation,
	},

	{
		...
		http.MethodPost,
		"/3gpp-m5/v2/network-assistance/:naSessionId/boost-request",
		RequestDeliveryBoost,
	},
