...
var routes = Routes{
	{
		"Index",
		http.MethodGet,
		"/3gpp-ndcaf_data-reporting-provisioning/v1/",
		Index,
	},

	{
		"CreateConfiguration",
		http.MethodPost,
		"/3gpp-ndcaf_data-reporting-provisioning/v1/sessions/:sessionId/configurations/:configurationId",
		CreateConfiguration,
	},
...

	{
		"DestroySession",
		http.MethodDelete,
		"/3gpp-ndcaf_data-reporting-provisioning/v1/sessions/:sessionId",
		DestroySession,
	},
